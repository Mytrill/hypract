...
// import { ListComponent as Config, ComponentProps, Entity, SimpleType } from '../types';
...
// const renderListItem = (entity: Entity, config: Config, value: object): JSX.Element => {
//   if(entity.__titleAttribute) {
...
// @observer
// export class ListComponent extends Component<ListProps, ListState> {

//   render(props: ListProps, state: ListState, context: AppContext) {
