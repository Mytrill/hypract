...
const throwError = (message, index) => {
...
let unary_ops: UnaryOperators = { '-': t, '!': t, '~': t, '+': t }
...
let binary_ops: BinaryOperators = {
'||': 1, '&&': 2, '|': 3, '^': 4, '&': 5,
'==': 6, '!=': 6, '===': 6, '!==': 6,
'<': 7, '>': 7, '<=': 7, '>=': 7,
'<<': 8, '>>': 8, '>>>': 8,
...
let createBinaryExpression = (operator, left, right) => {
...
export namespace jsep {
/**
 * @method jsep.addUnaryOp
 * @param {string} op_name The name of the unary op to add
 * @return jsep
 */
export const addUnaryOp = function (op_name) {
 ...
 * @return jsep
 */
export const addBinaryOp = function (op_name, precedence) {
 ...
 * @return jsep
 */
export const addLiteral = function (literal_name, literal_value) {
 ...
 * @return jsep
 */
export const removeUnaryOp = function (op_name) {
 ...
 * @return jsep
 */
export const removeAllUnaryOps = function () {
  unary_ops = {};
  max_unop_len = 0;
 ...
 * @return jsep
 */
export const removeBinaryOp = function (op_name) {
 ...
 * @return jsep
 */
export const removeAllBinaryOps = function () {
  binary_ops = {};
  max_binop_len = 0;
 ...
 * @return jsep
 */
export const removeLiteral = function (literal_name) {
 ...
 * @return jsep
 */
export const removeAllLiterals = function () {
  literals = {};
